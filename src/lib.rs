...
pub const SNAPSHOT_FD: &[config::Fd] = define_fields![
    ...
    "STATESYNC_RPC_SERVERS","Statesync RPC servers (comma-separated)","https://rpc.terp.chaintools.tech:443,https://rpc.terp.chaintools.tech:443",false,
...
pub const LR_TACKLES_FD: &[config::Fd] = define_fields![
    ...
    // Right tackle
    "P2P_P_TACKLE_R","Right tackle P2P port","26656",false,
    "RPC_P_TACKLE_R","Right tackle RPC port","26657",false,
    "API_P_TACKLE_R","Right tackle API port","1317",false,
    "GRPC_P_TACKLE_R","Right tackle gRPC port","9090",false,
    "RPC_D_TR","Right tackle RPC domain (optional)","",false,
    "API_D_TR","Right tackle API domain (optional)","",false,
    "P2P_D_TACKLE_R","Right tackle P2P domain (optional)","",false,
