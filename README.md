...
Image URL: `ghcr.io/terp-network/o-line:v0.0.6-generic`

```yaml
services:
  node:
    image: ghcr.io/terpnetwork/o-line:v0.0.6-generic
    env:
...
|---|---|---|---|
|[terp-network](https://github.com/terpnetwork/terp-core)|`v4.2.2`|`terpnetwork/o-line:v0.0.6`|[Example](./terpnetwork)|
